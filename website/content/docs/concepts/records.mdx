...
Future indexing could aggregate the proposal, authority lineage, checks, approval, transaction, and outcome into a human-readable Decision Receipt. Grantline does not currently run that indexer or publish those receipts.
