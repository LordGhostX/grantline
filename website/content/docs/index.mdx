...
<Callout type="info" title="Current MVP">
  ...
  windows, delegation, Preflight, owner-approved escalation, revocation,
  pausing, nonce cancellation, and native-asset USD valuation through Chainlink.
  The live deployment exercises most features; native-USD and SWAP require a
  manifest-configured feed and adapter to be active.
</Callout>

## Try the browser demo

The [browser demo](https://grantline.xyz/app) uses X Layer testnet. You need testnet OKB to pay transaction fees and fund a Vault; get it from the [X Layer testnet faucet](https://web3.okx.com/xlayer/faucet/xlayerfaucet).
