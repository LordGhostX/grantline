...
| 2026-08-13 | Add one roadmap page for deferred Guardians, SDK/API, and indexing/Decision Receipts.         | The public docs now explain future responsibilities and boundaries in one place without publishing speculative providers, schemas, endpoints, failure codes, or current-feature claims. |
